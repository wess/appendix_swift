...
public extension UINavigationController {
  public func pushViewController(controller:UIViewController, transition:UIView.AnimationTransition) {
  ...
  public func popViewControllerWithTransition(transition:UIView.AnimationTransition) -> UIViewController {
    UIView.beginAnimations(nil, context: nil)
